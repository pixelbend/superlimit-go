...
type ZenLimiter struct {
	client RedisClient
}

func NewLimiter(client RedisClient) *ZenLimiter {
	return &ZenLimiter{client: client}
}

func (b *ZenLimiter) Allow(ctx context.Context, key string, limit Limit) (*Result, error) {
	return b.AllowN(ctx, key, limit, 1)
}

func (b *ZenLimiter) AllowN(
	ctx context.Context,
	key string,
	limit Limit,
	n int,
...
func (b *ZenLimiter) Reset(ctx context.Context, key string) error {
